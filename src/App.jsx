              ...
              <tr key={product.id}>
                ...
                <td>
                  <div className="btn-group btn-group-sm">
                    ...
                    <button disabled={isLoading} type="button" className="btn btn-outline-danger" onClick={() => addCartItem(product.id, 1)}>
                      加到購物車
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button disabled={isLoading} type="button" className="btn btn-primary" onClick={() => addCartItem(tempProduct.id, qtySelect)}>
                加入購物車
                {isLoading && <ClipLoader 
                  color={'#000000'}
                  size={15}
